...
class UserSite(models.Model):
    UserID = models.ForeignKey(User, related_name='admin_app_user_id', db_column='UserID')
    SiteID = models.ForeignKey(Site, related_name='admin_app_site_id', db_column='SiteID')
